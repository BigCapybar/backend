...
{
    internal class Authication
    {
        public static string Issuer => "BazanyukB";
        public static string Audience => "ApiClient";
        public static int LifetimeInYears => 1;
        public static SecurityKey SigningKey => new SymmetricSecurityKey(Encoding.ASCII.GetBytes("bazanyukbogdanGogligg"));
